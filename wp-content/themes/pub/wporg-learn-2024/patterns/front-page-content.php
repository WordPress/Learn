...
<div class="wp-block-group" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--40)">
	...
	<p class="has-charcoal-4-color has-text-color has-link-color"><a href="/courses"><?php esc_html_e( 'See all Courses', 'wporg-learn' ); ?></a></p>
	<!-- /wp:paragraph -->
...
<div class="wp-block-query alignwide wporg-learn-course-grid">
	...
	<!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|50"}},"layout":{"type":"grid","columnCount":3}} -->
		...
		<!-- wp:group {"style":{"border":{"width":"1px","color":"var:preset|color|light-grey-1","radius":"2px"},"spacing":{"blockGap":"0"}},"layout":{"type":"constrained"}} -->
		<div class="wp-block-group has-border-color" style="border-color:var(--wp--preset--color--light-grey-1);border-width:1px;border-radius:2px">
