...
<div class="wp-block-group alignfull wporg-learn-sidebar-meta-info">
	...
	<!-- wp:sensei-lms/course-progress {<?php echo ( 'complete' === $course_status ? '"customTextColor":"var(--wp--custom--color--green-50)",' : '' ); ?>"customBarColor":"var(--wp--custom--color--green-50)","height":10,"className":"wporg-learn-sidebar-course-progress"} /-->
