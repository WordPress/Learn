...
const LessonFeaturedMeta = () => {
	...
	const [ lessonFeatured, setLessonFeatured ] = useState(
		postMetaData?._lesson_featured === FEATURED
	);

	return (
		<PluginDocumentSettingPanel
			title={ __( 'Featured Lesson', 'wporg-learn' ) }
		>
			<PanelRow>
				<CheckboxControl
					label={ __(
						'Feature this lesson on the front page',
						'wporg-learn'
					) }
					...
					onChange={ ( newLessonFeatured ) => {
						...
						editPost( {
							meta: {
								...postMetaData,
								_lesson_featured: newLessonFeatured
									? FEATURED
									: '',
							},
						} );
