...
Example: Bengali translation for course "Beginner WordPress User"
-->
...
- **Do you plan to translate whole course?:** Yes or No

# Course Modules:
Please add all course modules by copying one of the sample module formats below (for example, Module 1 or Module 2). For each lesson, create a separate GitHub issue to track its translation progress and link it here.

## Module 1 Title (Example: Getting started with WordPress)
